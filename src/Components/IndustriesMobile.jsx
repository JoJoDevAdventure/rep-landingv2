...
const IndustriesSectionMobile = () => {
  ...
  return (
    <section className="w-full py-8 flex flex-col items-center px-6 md:px-16 overflow-hidden">
      ...
      <div className="flex flex-row justify-start gap-4 mt-8 w-screen overflow-x-scroll py-2">
        {industries.map((industry) => (
          <button
            key={industry.name}
            onClick={() => setSelectedIndustry(industry)}
            className={`px-6 py-3 rounded-full transition-all duration-300 text-[12px] ${industry.name == "Real-Estate" ? "min-w-32" : ""} ${
      ...
      <div className="flex flex-col-reverse md:flex-row w-full max-w-5xl mt-12 items-center gap-8">
        ...
        >
          ...
          <a href="#" className={`${selectedIndustry.textColor} text-purple-500 mt-4 inline-block`}>
