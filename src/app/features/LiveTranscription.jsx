      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex flex-col items-start p-4 bg-white rounded-lg shadow-md">
            ...
            <h3 className="text-lg font-semibold text-p1">
              Live transcription
            </h3>
            <p className="mt-4 text-gray-700 text-sm leading-relaxed">
              That’s so root causes of the conflict in Putin’s head is existence
              of Ukraine as an independent, sovereign nation with a powerful
              military backed by the West and having strong aspirations to join
              NATO.
            </p>
          </div>
